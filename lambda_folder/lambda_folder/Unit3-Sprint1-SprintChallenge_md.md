...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  -- ANSWER: Throughout this sprint challenge and week, Ive had difficulty
  transferring my ideas into code. Sometimes, a simple question can produce
  a complicated and unnecessarily long and semantically incoherent piece of
  jargon that not even I can read. Knowing how to write not just good
  style code but code that not only performs its function, but is understandable
  is something Im starting to value and will improve on. Documentation is also
  important. Memory is fickle, it fades and next thing you know you can't read
  your own code. To summarize, readability and documentation are import aspects
  to look for when reviewing code. 
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  --ANSWER: It makes it easier to make, deploy, and run apps. Allows a dev to
  package up an app with all necessary parts and ship it all out as one
  package. Its become clear to me how much data there is, like, an unfathomable
  amount of data-- which in retrospect seemed obvious, but now having
  experienced working with data, it puts things in perspective. Things can get
  messy, cluttered, and overwhelming so being able to have a place to
  store such an amount of stuff makes stuff a little easier.
